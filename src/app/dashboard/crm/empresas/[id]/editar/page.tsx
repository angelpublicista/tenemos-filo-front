...
import { getCRMCompanyById, updateCRMCompany } from '@/lib/sanity/crmCompanyService';
import { CRMCompany, UpdateCRMCompanyData, CRMCompanyIndustry, CRMCompanySource } from '@/types';
...
export default function EditarEmpresaPage() {
  ...
  const onSubmit = async (data: CompanyFormData) => {
    ...
    try {
      ...
      const updateData: UpdateCRMCompanyData = {
        _id: company._id,
        companyName: data.companyName,
      ...
      await updateCRMCompany(company._id, updateData);
      showSuccess('Empresa actualizada correctamente');
      router.push(`/dashboard/crm/empresas/${company._id}`);
    } catch (error) {
  ...
  return (
    <ProtectedRoute>
      <div className="p-6 min-h-screen bg-gray-50 dark:bg-gray-900">
        {isLoading && <Loader message="Actualizando empresa..." />}
          ...
          <Card>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Select
                  id="address-country"
                  defaultValue={company.address?.country || 'CO'}
                  className="mt-1"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <TextInput
                  id="social-linkedin"
                  type="url"
                  defaultValue={company.socialMedia?.linkedin || ''}
              ...
              <div>
                ...
                <TextInput
                  id="social-twitter"
                  type="url"
                  defaultValue={company.socialMedia?.twitter || ''}
              ...
              <div>
                ...
                <TextInput
                  id="social-facebook"
                  type="url"
                  defaultValue={company.socialMedia?.facebook || ''}
              ...
              <div>
                ...
                <TextInput
                  id="social-instagram"
                  type="url"
                  defaultValue={company.socialMedia?.instagram || ''}
