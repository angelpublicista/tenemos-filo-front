...
import { HiOutlineDesktopComputer, HiCheckCircle, HiRefresh } from 'react-icons/hi';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">
              Integra tu calendario de Microsoft 365
            </p>
          </div>
        </div>
        {getStatusBadge()}
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-xs">
                {integration.config?.tenantId ? integration.config.tenantId.slice(0, 8) + '...' : 'Personal'}
              </span>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-3">
        <div className="text-sm text-gray-600">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>Reunión automática bloqueada</li>
